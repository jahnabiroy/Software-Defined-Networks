...
from time import sleep, time  # Import time here
from ryu.lib.packet import ether_types
import heapq  # Add this import at the top
from ryu.lib.packet import lldp  # Add this import
...
class LearningSwitch(app_manager.RyuApp):
    ...
    def send_lldp_packets(self):
        ...
        # self.logger.info("Switches are: %s",self.switch_ids)
        ...
        if eth.ethertype == ether_types.ETH_TYPE_LLDP:
            ...
            if chassis_id is not None:
                ...
                if part1 == "Link_Delay":
                    ...
                    self.link_delay[dpid][part2] = min(min(current1, current2), link_delay * 1000)
                    self.link_delay[part2][dpid] = min(min(current1, current2), link_delay * 1000)
            ...
            while priority_queue:
                ...
                for neighbor in self.link_delay.get(current_node,{}):
                    ...
                    if new_distance < distance.get(neighbor, float("inf")):
                        ...
                        ports[neighbor] = ports.get(current_node, self.link[current_node].get(neighbor,4294967294))
        ...
        def bfs(node, parent, original_switch, original_port, visited,spt_edges):
            ...
            for neighbor in spt_edges[node]:
                if neighbor != parent:
                    ...
                    bfs(neighbor, node, original_switch, original_port, visited,spt_edges)
